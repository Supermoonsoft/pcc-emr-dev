...
/**
 * GatewayCDrugItemsSearch represents the model behind the search form about `app\modules\stock\models\GatewayCDrugItems`.
 */
class GatewayCDrugItemsSearch extends GatewayCDrugItems
{
    ...
    {
        return [
            [['id', 'hospcode', 'hospname', 'icode', 'drug_name', 'qty', 'unit', 'usage_line1', 'usage_line2', 'usage_line3', 'tmt24_code'], 'safe'],
